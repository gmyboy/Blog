...
import com.gmy.blog.widget.pulltorefresh.ILoadingLayout.State;
 ...
 * @since 2013-8-15
 */
public class PullToRefreshListView extends PullToRefreshBase<AsyncListView>
	...
	@Override
	protected AsyncListView createRefreshableView(Context context, AttributeSet attrs) {
